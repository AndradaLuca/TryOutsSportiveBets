...
public class DataGenerator {
   ...
   public static final String[] cnp = new String[]{"2970312125746", "1900423465789","1801223495756"};
   public static final String[] name = new String[] {"Luca Andrada", "Pascalau Marius","Luca Adrian"};
   ...
   public static final String[] password = new String[]{"andrada","marius","adrian"};
