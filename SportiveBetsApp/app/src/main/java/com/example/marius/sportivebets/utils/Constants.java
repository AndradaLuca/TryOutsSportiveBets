...
public class Constants {
  ...
  /*  private static Game game1 = new Game("Botosani", "Astra Giurgiu", 2.40, 3.15, 3.15,1);
    private static Game game2 = new Game("Concordia", "Hermannstadt", 2.00, 4.15, 3.25,1);
    private static Game game3 = new Game("Sepsi", "CSMS Iasi", 2.05, 4.00, 3.25,1);
    private static Game game4 = new Game("Dunarea Calarasi", "Universitatea Craiova", 3.85, 2.05, 3.35,1);
    private static Game game5 = new Game("FC Voluntari", "CFR Ecomax", 4.40, 1.90, 3.35,1);


    private static Game game6 = new Game("CS Balotesti", "Petrolu Ploiesti", 5.45, 1.54, 3.75,2);
    private static Game game7 = new Game("Academia Clinceni", "Daco-Getica", 2.35, 2.60, 3.35,2);
    private static Game game8 = new Game("Sportul Snagov", "CS Mioveni", 2.25, 2.80, 3.25,2);
    private static Game game9 = new Game("Luceafarul", "Ripensia", 2.45, 2.55, 3.25,2);
    private static Game game10 = new Game("Metaloglobus", "Aerostar Bucuresti", 2.55, 2.45, 3.25,2);

    private static Game game11 = new Game("Man Utd", "Leicester", 1.50, 7.50, 4.15,3);
    private static Game game12 = new Game("NewCastle", "Tottenham", 3.75, 2.05, 3.45,3);
    private static Game game13 = new Game("Huddersfield", "Chelsea", 5.95, 1.62, 3.85,3);
    private static Game game14 = new Game("Watford", "Brighton", 2.30, 3.35, 3.25,3);
    private static Game game15 = new Game("Fulham", "Crystal Palace", 2.35, 3.10, 3.35,3);

    private static Game game16 = new Game("Barcelona", "Sevilla", 1.55, 5.85, 4.25,4);

    private static Game game17 = new Game("Real Madrid", "Atletico Madrid", 2.45, 2.95, 3.25,5);

    private static Game game18 = new Game("Eintracht", "Bayer Munchen", 6.65, 1.42, 4.76,6);

    private static Game game19 = new Game("Chelsea", "Lyon", 2.15, 3.45, 3.55,7);
    private static Game game20 = new Game("Real Madrid", "AS Roma", 1.76, 4.15, 4.15,7);
    private static Game game21 = new Game("Atletico Madrid", "Inter Milan", 2.15, 3.45, 3.56,7);

    private static Game game22 = new Game("Marseille", "Toulouse", 1.41, 7.75, 4.45,8);
    private static Game game23 = new Game("Nantes", "Monaco", 3.23, 2.34, 3.25,8);
    private static Game game24 = new Game("Angers", "Nimes", 2.31, 3.25, 3.27,8);
    private static Game game25 = new Game("Lille", "Stade Rennes", 2.55, 2.95, 3.15,8);

    private static Game game26 = new Game("FK Qarabag", "BATE Borisov", 7.25, 1.54, 3.55,9);
    private static Game game27 = new Game("Malmo", "MOL Vidi", 2.25, 5.15, 2.45,9);
    private static Game game28 = new Game("Slavia Prague", "Dynamo Kiev", 2.45, 3.45, 2.75,9);
    private static Game game29 = new Game("Red Star", "Spartak", 1.23, 15.7, 5.45,9);
    ...
    public static List<ExpandableLeague> leagueTitles = Arrays.asList(new ExpandableLeague("Romania - Liga 1", league1),
            new ExpandableLeague("Romania - Liga 2", league2), new ExpandableLeague("Anglia - Premier ExpandableLeague", league3),
            new ExpandableLeague("Spain Super Cup", league4), new ExpandableLeague("UEFA Super Cup", league5),
            new ExpandableLeague("Germany Super Cup", league6), new ExpandableLeague("International Champions Cup", league7),
            new ExpandableLeague("France - Ligue 1", league8), new ExpandableLeague("Champions ExpandableLeague Qualifying", league9));*/
